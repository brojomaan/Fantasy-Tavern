...
namespace Coherence.Brook
{
    ...
    public class OutBitStream : IOutBitStream
    {
        ...
        private IOctetWriter octetWriter;
        private uint octetWriterInitialPosition;
        private int remainingBits;

        [ThreadStatic]
        private static OutBitStream shared;
        public static OutBitStream Shared
        {
            get
            {
                if (shared == null)
                {
                    shared = new OutBitStream(null);
                }
                return shared;
            }
        }
        ...
        public OutBitStream Reset(IOctetWriter octetWriter)
        {
            this.octetWriter = octetWriter;
            this.octetWriterInitialPosition = octetWriter != null ? octetWriter.Position : 0;
            this.Accumulator = 0;
            this.IsFull = false;
            this.Position = 0;
            this.OverflowBitCount = 0;
            this.remainingBits = AccumulatorSize;
