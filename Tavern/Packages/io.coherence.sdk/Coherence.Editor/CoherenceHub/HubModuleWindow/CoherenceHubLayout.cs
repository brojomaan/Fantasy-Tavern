...
namespace Coherence.Editor
{
    ...
    internal static class CoherenceHubLayout
    {
        ...
        public static void DrawDiskPath(string currentPath, string infoString, Func<string> unityPanel, Action<string> onChangePath)
        {
            ...
            EditorGUILayout.SelectableLabel(text, EditorStyles.miniLabel, GUILayout.Height(EditorGUIUtility.singleLineHeight).AsTempArray());
            if (GUILayout.Button("Browse", EditorStyles.miniButton, GUILayout.Width(64).AsTempArray()))
            {
        ...
        public static bool DrawToggle(string text, bool value, GUILayoutOption options) => EditorGUILayout.Toggle(text, value, options.AsTempArray());
        public static string DrawTextField(string text) => EditorGUILayout.TextField(text);
        public static string DrawTextField(string label, string text) => EditorGUILayout.TextField(label, text);
        public static int DrawIntField(string label, int value) => EditorGUILayout.IntField(label, value);

        public static int DrawGrid(int tabindex, GUIContent[] contents)
        {
            ...
            return GUILayout.SelectionGrid(tabindex, contents, columnCount, style);
        }

        public static void DrawBoldLabel(GUIContent content) => EditorGUILayout.LabelField(content, Styles.BoldLabel);
        public static void DrawBoldLabel(GUIContent content, GUILayoutOption options) => EditorGUILayout.LabelField(content, Styles.BoldLabel, options.AsTempArray());

        public static void DrawListLabel(GUIContent content)
        {
            using (new EditorGUILayout.VerticalScope())
            {
                EditorGUILayout.LabelField(content, Styles.Label);
            }
        }

        public static void DrawLabel(GUIContent content) => EditorGUILayout.LabelField(content, Styles.Label);
        public static void DrawLabel(GUIContent content, GUILayoutOption options) => EditorGUILayout.LabelField(content, Styles.Label, options.AsTempArray());
        public static void DrawLabel(GUIContent content, GUILayoutOption[] options) => EditorGUILayout.LabelField(content, Styles.Label, options);
        internal static void DrawLabel(GUIContent label, GUIContent content, GUILayoutOption options) => EditorGUILayout.LabelField(label, content, Styles.Label, options.AsTempArray());
        ...
        public static bool DrawButton(GUIContent content, bool allowWordWrap = true, GUIStyle buttonStyle = null)
        {
            var style = buttonStyle ?? (allowWordWrap ? Styles.Button : Styles.ButtonNoLineWrap);
            return GUILayout.Button(content, style);
        }

        public static bool DrawButton(GUIContent content, GUILayoutOption options, bool allowWordWrap = true, GUIStyle buttonStyle = null)
        {
            var style = buttonStyle ?? (allowWordWrap ? Styles.Button : Styles.ButtonNoLineWrap);
            return GUILayout.Button(content, style, options.AsTempArray());
        }
        ...
        internal static void DrawCloudDependantButton(GUIContent content, Action onButtonPress, string tooltip, Func<bool> disableConditions = null, GUIStyle buttonStyle = null)
        {
            ...
            {
                if (DrawButton(conditionalContent ?? content, buttonStyle: buttonStyle))
                {
