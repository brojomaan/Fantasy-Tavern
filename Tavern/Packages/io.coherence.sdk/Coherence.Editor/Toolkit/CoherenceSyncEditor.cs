...
namespace Coherence.Editor.Toolkit
{
    ...
    internal partial class CoherenceSyncEditor : BaseEditor
    {
        ...
        private static partial class GUIContents
        {
            ...
            public static readonly GUIContent synchronizeParentLabel =
                EditorGUIUtility.TrTextContent("Synchronize Parent",
        ...
        private SerializedProperty synchronizeParentProperty;
        ...
        protected override void OnEnable()
        {
            ...
            synchronizeParentProperty = serializedObject.FindProperty(nameof(CoherenceSync.synchronizeParent));
        ...
        protected override void OnDisable()
        {
            ...
            synchronizeParentProperty?.Dispose();
        ...
        private void DrawSynchronizeParent()
        {
            EditorGUI.BeginChangeCheck();
            _ = EditorGUILayout.PropertyField(synchronizeParentProperty, GUIContents.synchronizeParentLabel);
            if (EditorGUI.EndChangeCheck())
            {
                ReportAnalytic("synchronize_parent", synchronizeParentProperty.boolValue);
            }
        }
        ...
        internal static void DrawFixHelpBox(SerializedObject serializedObject, GameObjectStatus status, string message, GUIContent buttonLabel, Action<SerializedObject> fixSync, MessageType messageType = MessageType.Warning, bool canTargetNonAssets = false)
        {
            EditorGUILayout.BeginVertical(GUI.skin.box);
            ...
            if (!canTargetNonAssets && status is { IsRootOfPrefabStageHierarchy: true, PrefabStageMode: PrefabStageMode.InContext })
            {
            ...
            else if (!canTargetNonAssets && (status.IsInstanceInScene || status.IsNestedInstanceInsideAnotherPrefab))
            {
            ...
            else if (canTargetNonAssets || (status.IsAsset || status is { IsRootOfPrefabStageHierarchy: true, PrefabStageMode: PrefabStageMode.InIsolation }))
            {
