...
namespace Coherence.Editor.Toolkit
{
    ...
    internal class ObjectPickerDrawer : PropertyDrawer
    {
        ...
        private void UpdateReference(Object obj)
        {
            ...
            var oldObj = cachedProperty.objectReferenceValue;

            if (oldObj != obj)
            {
                OnReferenceChanging(oldObj, obj);
            }
            ...
            if (oldObj != obj)
            {
                OnReferenceChanged(oldObj, obj);
            }
        }

        protected virtual void OnReferenceChanging(Object oldReference, Object newReference)
        {
        }
