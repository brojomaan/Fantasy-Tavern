...
namespace Coherence.Editor.Portal
{
    ...
    internal class ReplicationServer
    {
        ...
        public static bool Restart()
        {
            ...
            using var req = new PortalRequest(Endpoints.restartUrlPath, "POST", autoDispose: false);
        ...
        public static bool Deploy()
        {
            ...
            using var req = new PortalRequest(Endpoints.deployUrlPath, "POST", autoDispose: false);
