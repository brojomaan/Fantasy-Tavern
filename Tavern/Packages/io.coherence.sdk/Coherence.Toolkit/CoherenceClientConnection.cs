...
namespace Coherence.Toolkit
{
    ...
    public class CoherenceClientConnection
    {
        ...
        /// <summary>
        /// Current scene index of the client.
        /// </summary>
        public uint Scene { get; internal set; }
        ...
        internal CoherenceClientConnection(ICoherenceBridge bridge, Entity entityId,
            ClientID clientId, ConnectionType type, bool isMine, uint scene)
        {
            this.bridge = bridge;
        ...
        internal CoherenceClientConnection(ICoherenceBridge bridge, NetworkEntityState networkEntity,
            Entity entityId, ClientID clientId, ConnectionType type, uint scene)
            : this(bridge, entityId, clientId, type, networkEntity.AuthorityType.Value.ControlsState(), scene)
        {
