...
namespace Coherence.Simulator
{
    ...
    [HelpURL("https://docs.coherence.io/v/2.1/manual/simulation-server/client-vs-simulator-logic#connecting-simulators-automatically-to-rs-autosimulatorconnection-component")]
    ...
    public class AutoSimulatorConnection : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            ...
            var isValid = endpoint.ValidateLocalAddress().HasFlag(EndpointData.ValidationResult.ValidEndpoint);
            if (!isValid)
            {
