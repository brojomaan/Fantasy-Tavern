...
namespace Coherence.Common
{
    ...
    internal static class TaskExtensions
    {
        ...
        /// <param name="action"> Delegate to execute when the task completes. </param>
        /// <param name="cancellationToken"> Token for canceling the continuation action. </param>
        public static void Then<TResult>([DisallowNull] this Task<TResult> task, [DisallowNull] Action<TResult> action, CancellationToken cancellationToken = default)
            => task.ContinueWith(completedTask => action(completedTask.Result), cancellationToken, TaskContinuationOptions.None, TaskUtils.Scheduler);
    }
}
