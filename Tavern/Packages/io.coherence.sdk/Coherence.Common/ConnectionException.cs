...
namespace Coherence.Connection
{
    ...
    {
        public IPEndPoint ClosedEndpoint => closedEndpoint;

        private readonly IPEndPoint closedEndpoint;
        ...
        public ConnectionClosedException(IPEndPoint endpoint, string message, Exception innerException) : base(message, innerException)
        {
