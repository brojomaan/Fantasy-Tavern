...
namespace Coherence.Log
{
    public enum Error
    {
        ...
        RuntimeWebsocketDisconnectFailed,
        ...
        ToolkitBindingDescriptorCreationFailed,
        EditorUpdateSyncStateFailed,
        EditorBakingFailed,
        EditorUploadingSchemasFailed,
        EditorCodeGenerationFailed,
        TCPListenerInitialHeaderException,
        TCPListenerInitialHeaderMagicCode,
        TCPListenerMissingRoom,
        TCPListenerConnectionTimedOut,
        TCPListenerFailedToAcceptClient,
        InConnectionProcessingIncomingPacket,
    }
...
#pragma warning restore CS8524
            {
                ...
                Error.EditorBakeTimeout => "", // Uses ErrorMsg.
                Error.EditorUpdateSyncStateTimeout => "", // Uses ErrorMsg.
                ...
                Error.RuntimeWebsocketDisconnectFailed => "", // Uses ErrorMsg.
                ...
                Error.ToolkitBindingDescriptorCreationFailed => "", // Uses ErrorMsg
                Error.EditorUpdateSyncStateFailed => "", // Uses ErrorMsg
                Error.EditorBakingFailed => "", // Uses ErrorMsg
                Error.EditorUploadingSchemasFailed => "", // Uses ErrorMsg
                Error.EditorCodeGenerationFailed => "", // Uses ErrorMsg
                Error.TCPListenerInitialHeaderException => "Exception while receiving initial header from new TCP connection.",
                Error.TCPListenerInitialHeaderMagicCode => "Invalid magic code received from incoming TCP connection.",
                Error.TCPListenerMissingRoom => "Room not found for incoming TCP connection.",
                Error.TCPListenerConnectionTimedOut => "TCP connection timed out while waiting for magic code and room UID.",
                Error.TCPListenerFailedToAcceptClient => "Failed to accept incoming TCP client.",
                Error.InConnectionProcessingIncomingPacket => "Error processing incoming packet.",
